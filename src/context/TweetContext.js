    ...
    switch (action.type) {
      ...
      case "DELETE":
        ...
        action.attachmentUrl !== "" &&
          storageService.refFromURL(action.attachmentUrl).delete();
        return {
          ...state,
          myTweets: state.myTweets.filter(
            (tweet) => tweet.docId !== action.docId
          ),
